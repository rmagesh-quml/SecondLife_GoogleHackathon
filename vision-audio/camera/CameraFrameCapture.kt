 ...
 *
 * Contract → Shravan:
 *   android.graphics.Bitmap — 768×768 px, ARGB_8888 (alpha always 0xFF for camera frames).
 *   CENTER_CROP scaling preserves aspect ratio; EXIF orientation is applied
 *   automatically by ImageProxy.toBitmap() (CameraX ≥ 1.2).
 */
class CameraFrameCapture(
    ...
    /** Binds CameraX to the provided lifecycle. Must be called before captureFrame(). */
    ...
    /** Takes one photo and returns it scaled/cropped to TARGET_SIZE × TARGET_SIZE. */
    ...
    /** Unbinds the camera and releases all resources. */
    fun release() {
